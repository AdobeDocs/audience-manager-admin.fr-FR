...
1. Accédez à l’outil de [!DNL Admin] d’Audience Manager en vous rendant sur la [!DNL URL] suivante : [https://admin.demdex.com/](https://admin.demdex.com/).
1. Sélectionnez la méthode de vérification souhaitée dans la liste déroulante, puis cliquez sur **[!UICONTROL Verify]**.
