...
Ces macros peuvent être utilisées dans n’importe quel champ de format. Pour obtenir une liste et des définitions complètes, voir [Macros au format de fichier](../formats/file-formats.md).
...
Macros utilisées uniquement dans les champs d’en-tête. Pour obtenir une liste et des définitions complètes, voir [Macros au format de fichier](../formats/file-formats.md).
