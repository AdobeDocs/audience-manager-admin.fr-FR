...
Répertorie les macros que vous pouvez utiliser pour créer [!DNL HTTP] des fichiers de données. [!DNL HTTP] envoie les données dans un [!DNL JSON] format.
...
<table id="table_72A72EA63C3643FB84B47A76CD2CC1CA"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p> <span class="keyword"> Identifiant </span> Audience Manager. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Horodatage UTC Unix. Un horodatage interne représente l’heure à laquelle AAM a été averti de publier la destination <span class="wintitle"> S2S </span> auprès de nos partenaires. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Experience Cloud ID. (MCID signifie Marketing Cloud, qui est le nom hérité d’Experience Cloud) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>NUM_REMOVED_SEGMENTS</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Nombre (entier) de segments auquel un utilisateur n’appartient plus. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET, POST</code> </p> </td> 
   <td colname="col3"> <p>alias de l’ID de partenaire. Egalement appelé ID de compte étranger. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Renvoie une liste d’ID de segment, le cas échéant, auxquels un utilisateur n’est plus admissible. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>REMOVED_SEGMENTS</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Liste des segments pour lesquels un utilisateur n’est plus admissible. Vous pouvez également renvoyer des champs de segment spécifiques qui comprennent : </p> <p> 
     ...
     </ul> </p> <p>Spécifiez les champs suivants dans un tableau, comme illustré dans cet exemple : </p> <p> <code>[&lt;REMOVED_SEGMENTS:{seg|&lt;OPEN_BRACKET&gt;"Mapping":&lt;seg.traitAlias&gt;,"Status:"&lt;seg.status&gt;, "Time":&lt;seg.dateTime&gt;,"LegacySegmentId":&lt;seg.LegacySegmentId&gt;, "NewSegmentId":&lt;seg.New SegmentId&gt;&lt;CLOSE_BRACKET&gt;}; "separator=","&gt;]</code> </p> <p>Voir aussi <a href="../formats/web-format-examples.md#reference_98828E32B0964FF9AAC7C5400E88BA31"> Exemples de macros au format HTTP </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Liste des noms de segments avec alias auxquels un utilisateur n’est plus admissible. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>SEGMENT_LIST</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Renvoie une liste d’ID de segment. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>SEGMENTS</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Liste des segments pour lesquels un utilisateur est admissible. Vous pouvez également renvoyer des champs de segment spécifiques qui comprennent : </p> <p> 
     ...
     </ul> </p> <p>Spécifiez les champs suivants dans un tableau, comme illustré dans cet exemple : </p> <p> <code>[&lt;SEGMENTS:{seg|&lt;OPEN_BRACKET&gt;"Mapping":&lt;seg.traitAlias&gt;,"Status:"&lt;seg.status&gt;, "Time":&lt;seg.dateTime&gt;,"LegacySegmentId":&lt;seg.LegacySegmentId&gt;, "NewSegmentId":&lt;seg.NewSegment&gt;&lt;CLOSE_BRACKET&gt;}; "separator=","&gt;]</code> </p> <p>Voir aussi <a href="../formats/web-format-examples.md#reference_98828E32B0964FF9AAC7C5400E88BA31"> Exemples de macros au format HTTP </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Liste de noms de alias pour un segment particulier. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>PUBLIER</code> </p> </td> 
   <td colname="col3"> <p>Liste des ID <span class="keyword"> utilisateur d’Audience Manager </span> . Vous pouvez également renvoyer des champs spécifiques qui incluent les éléments suivants : </p> 
