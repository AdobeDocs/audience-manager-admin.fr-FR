...
Répertorie les macros que vous pouvez utiliser pour créer des fichiers de données [!DNL HTTP]. [!DNL HTTP] envoie les données dans un format [!DNL JSON].

Consultez la section [Exemples de macros au format HTTP](../formats/web-format-examples.md) pour obtenir une liste et des exemples de combinaisons de macros couramment utilisées.
...
<table id="table_72A72EA63C3643FB84B47A76CD2CC1CA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>ID du fournisseur de données. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Experience Cloud ID. (MCID signifie Marketing Cloud, qui est l’ancien nom d’Experience Cloud) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>NUM_REMOVED_SEGMENTS</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Nombre (entier) de segments auxquels un utilisateur ou une utilisatrice n’appartient plus. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>NUM_SEGMENTS</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Nombre de segments auxquels appartient un utilisateur. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>ORDER_ID</code> </p> </td> 
   <td colname="col2"> <p> <code>GET, POST</code> </p> </td> 
   <td colname="col3"> <p>Identifiant de commande ou de destination. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>PID_ALIAS</code> </p> </td> 
   <td colname="col2"> <p> <code>GET, POST</code> </p> </td> 
   <td colname="col3"> <p>Alias pour l’ID de partenaire. Également appelé identifiant de compte étranger. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>La région <a href="https://experienceleague.adobe.com/docs/audience-manager/user-guide/api-and-sdk-code/dcs/dcs-api-reference/dcs-regions.html?lang=fr"> Audience Manager DCS </a> d’où provient l’activité.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>REMOVED_SEGMENT_LIST</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Renvoie une liste des identifiants de segment, le cas échéant, pour lesquels un utilisateur n’est plus éligible. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>REMOVED_SEGMENTS</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Liste des segments pour lesquels un utilisateur ou une utilisatrice n’est plus admissible. Vous pouvez également renvoyer des champs de segment spécifiques qui incluent : </p> <p> 
     ...
     </ul> </p> <p>Spécifiez ces champs dans un tableau, comme illustré dans l’exemple suivant : </p> <p> <code>[&lt;REMOVED_SEGMENTS:{seg|&lt;OPEN_BRACKET&gt;"Mapping":&lt;seg.traitAlias&gt;,"Status:"&lt;seg.status&gt;, "Time":&lt;seg.dateTime&gt;,"LegacySegmentId":&lt;seg.LegacySegmentId&gt;, "NewSegmentId":&lt;seg.NewSegmentId&gt;&lt;CLOSE_BRACKET&gt;}; "separator=","&gt;]</code> </p> <p>Consultez également <a href="../formats/web-format-examples.md#reference_98828E32B0964FF9AAC7C5400E88BA31"> section Exemples de macros au format HTTP </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>REMOVED_TIME_LIST</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> Liste des dernières réalisations pour les segments pour lesquels l’utilisateur n’est plus éligible. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>REMOVED_TRAITALIAS_LIST</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Liste des noms avec alias des segments pour lesquels un utilisateur ou une utilisatrice ne répond plus aux critères. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Liste des segments pour lesquels un utilisateur est éligible. Vous pouvez également renvoyer des champs de segment spécifiques qui incluent : </p> <p> 
     ...
     </ul> </p> <p>Spécifiez ces champs dans un tableau, comme illustré dans l’exemple suivant : </p> <p> <code>[&lt;SEGMENTS:{seg|&lt;OPEN_BRACKET&gt;"Mapping":&lt;seg.traitAlias&gt;,"Status:"&lt;seg.status&gt;, "Time":&lt;seg.dateTime&gt;,"LegacySegmentId":&lt;seg.LegacySegmentId&gt;, "NewSegmentId":&lt;seg.NewSegmentId&gt;&lt;CLOSE_BRACKET&gt;}; "separator=","&gt;]</code> </p> <p>Consultez également <a href="../formats/web-format-examples.md#reference_98828E32B0964FF9AAC7C5400E88BA31"> section Exemples de macros au format HTTP </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Unix, date et heure UTC. Représente la dernière réalisation du segment. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>TRAITALIAS_LIST</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Liste de noms avec alias pour un segment particulier. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Une liste d’ID d’utilisateur <span class="keyword"> Audience Manager </span>. Vous pouvez également renvoyer des champs spécifiques qui incluent les éléments suivants : </p> 
