...
seo-description: Liste les macros que vous pouvez utiliser pour créer des fichiers de données HTTP. HTTP envoie des données au format JSON.
...
<table id="table_72A72EA63C3643FB84B47A76CD2CC1CA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET, POST</code> </p> </td> 
   <td colname="col3"> <p>Alias de l’ID de partenaire. Egalement appelé identifiant de compte étranger. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Renvoie une liste d’ID de segment, le cas échéant, pour lesquels un utilisateur n’est plus admissible. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>Liste de segments pour laquelle un utilisateur n’est plus admissible. Vous pouvez également renvoyer des champs de segment spécifiques qui incluent : </p> <p> 
     ...
     </ul> </p> <p>Spécifiez les champs suivants dans un tableau, comme indiqué dans cet exemple : </p> <p> <code>[&lt;REMOVED_SEGMENTS:{seg|&lt;OPEN_BRACKET&gt;"Mapping":&lt;seg.traitAlias&gt;,"Status:"&lt;seg.status&gt;, "Time":&lt;seg.dateTime&gt;,"LegacySegmentId":&lt;seg.LegacySegmentId&gt;, "NewSegmentId":&lt;seg.NewSegmentId&gt;&lt;CLOSE_BRACKET&gt;}; "separator=","&gt;]</code> </p> <p>Voir aussi <a href="../formats/web-format-examples.md#reference_98828E32B0964FF9AAC7C5400E88BA31"> Exemples de macros au format HTTP </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Liste de segments pour lesquels un utilisateur est admissible. Vous pouvez également renvoyer des champs de segment spécifiques qui incluent : </p> <p> 
     ...
     </ul> </p> <p>Spécifiez les champs suivants dans un tableau, comme indiqué dans cet exemple : </p> <p> <code>[&lt;SEGMENTS:{seg|&lt;OPEN_BRACKET&gt;"Mapping":&lt;seg.traitAlias&gt;,"Status:"&lt;seg.status&gt;, "Time":&lt;seg.dateTime&gt;,"LegacySegmentId":&lt;seg.LegacySegmentId&gt;, "NewSegmentId":&lt;seg.NewSegmentId&gt;&lt;CLOSE_BRACKET&gt;}; "separator=","&gt;]</code> </p> <p>Voir aussi <a href="../formats/web-format-examples.md#reference_98828E32B0964FF9AAC7C5400E88BA31"> Exemples de macros au format HTTP </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Horodatage Unix, UTC. Représente la dernière réalisation du segment. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Agent utilisateur de la demande initiale. </p> </td> 
  </tr> 
  <tr> 
