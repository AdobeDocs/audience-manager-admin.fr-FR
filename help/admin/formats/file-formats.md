...
Macros utilisées dans les lignes de données uniquement. Pour obtenir des exemples, voir [Exemples de macro Format du fichier](../formats/file-format-examples.md).
