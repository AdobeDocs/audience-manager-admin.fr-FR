---
description: Vous pouvez activer les transferts de lots sortants de fichiers de séquence d’Hadoops binaires (SEQ) pour les clients Audience Manager.
...
title: Activer les transferts de fichiers de séquences d’Hadoop pour les fichiers sortants
...
# Activer les transferts de fichiers de séquences d’Hadoop pour les fichiers sortants {#enable-hadoop-sequence-file-transfers-for-outbound}
...
1. Sélectionnez Protocol : **[!UICONTROL FTP]** ou **[!UICONTROL S3]**.
