...
>[!NOTE]
>
>Pour le type de destination [!UICONTROL Bulk ID], vous ne pouvez pas utiliser l’[!DNL Audience Manager] [!UICONTROL User ID] ou l’identifiant [!DNL Adobe Experience Cloud].
